...
//Get user details
exports.userDetails = catchAsycErrors(async (req, res, next) => {
...
// Get all users(admin)
exports.getAllUser = catchAsycErrors(async (req, res, next) => {
...
exports.getSingleUser = catchAsycErrors(async (req, res, next) => {
